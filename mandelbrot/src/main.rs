...
/// plane designatig the area our image covers
...
/// which holds one grayscale pixel per byte. The 'upper-left' and 'lower_right'
/// arguments specify points on the complex plane corresponding to the upper-
/// lefft and lower_right corners of the pixel buffer.
